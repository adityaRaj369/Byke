      ...
      <TouchableOpacity
        ...
        <View className="mt-4 pt-4 border-t border-gray-50 flex-row items-center justify-between">
          <View className="flex-row items-center">
            ...
            <Text className="text-xs font-black text-gray-700 uppercase">
              {vehicle}
            </Text>
          </View>
          <View className="flex-row items-center">
            <Text className="text-sm font-black text-green-600 mr-2">
              Accept Offer
            </Text>
        ...
        <View className="bg-black rounded-3xl p-6 mb-6 shadow-xl shadow-black/20">
          <View className="flex-row items-center justify-between mb-4">
            <View className="bg-yellow-400 px-3 py-1.5 rounded-xl">
              <Text className="text-[10px] font-black text-black uppercase tracking-tighter">
                Your Max Price
              </Text>
        ...
        <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
          {loading && bids.length === 0 ? (
            <View className="py-20 items-center">
              ...
              <Text className="text-gray-400 mt-6 font-black uppercase tracking-widest text-xs">
                Finding best offers...
              </Text>
            </View>
          ) : bids.length === 0 ? (
            <View className="py-20 items-center">
              ...
              <Text className="text-gray-900 text-xl font-black mb-2">
                Almost there!
              </Text>
              <Text className="text-gray-400 text-center px-10 font-bold leading-5">
