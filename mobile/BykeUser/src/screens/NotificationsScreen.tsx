...
const NotificationsScreen = ({ navigation }: any) => {
  ...
  const getIcon = (type: string) => {
    switch (type) {
      case 'RIDE_ACCEPTED': return { icon: CheckCircle2, color: '#10B981' };
      case 'RIDER_ARRIVED': return { icon: Bell, color: '#EAB308' };
...
const styles = StyleSheet.create({
  ...
  header: { paddingHorizontal: 24, paddingTop: 16, paddingBottom: 24, flexDirection: 'row', alignItems: 'center' },
  backButton: { backgroundColor: '#F9FAFB', padding: 10, borderRadius: 12, borderWidth: 1, borderColor: '#F3F4F6', marginRight: 16 },
  headerTitle: { fontSize: 24, fontWeight: '900', color: 'black' },
  headerSubtitle: { fontSize: 10, fontWeight: '900', color: '#9CA3AF', textTransform: 'uppercase', letterSpacing: 1, marginTop: 2 },
  listContent: { padding: 24 },
  notifCard: { flexDirection: 'row', padding: 20, marginBottom: 16, borderRadius: 32, borderWidth: 1, borderColor: '#F3F4F6', backgroundColor: 'white' },
  ...
  notifTitle: { fontSize: 16, flex: 1, paddingRight: 8, fontWeight: '700', color: '#374151' },
  fontBlack: { fontWeight: '900', color: 'black' },
  unreadDot: { width: 8, height: 8, borderRadius: 4, backgroundColor: '#EAB308', marginTop: 8 },
  notifMessage: { fontSize: 14, fontWeight: '600', color: '#6B7280', lineHeight: 20, marginBottom: 8 },
  notifTime: { fontSize: 10, fontWeight: '900', color: '#9CA3AF', textTransform: 'uppercase' },
  emptyContainer: { flex: 1, alignItems: 'center', justifyContent: 'center', paddingVertical: 100, paddingHorizontal: 40 },
  emptyIconContainer: { backgroundColor: '#F9FAFB', padding: 40, borderRadius: 50, marginBottom: 32, borderWidth: 1, borderColor: '#F3F4F6' },
  emptyTitle: { fontSize: 20, fontWeight: '900', color: 'black', marginBottom: 8 },
  emptySubtitle: { fontSize: 14, color: '#9CA3AF', textAlign: 'center', fontWeight: '600', lineHeight: 20 }
});
