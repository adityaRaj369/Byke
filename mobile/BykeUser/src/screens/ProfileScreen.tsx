...
import { User, MapPin, CreditCard, Bell, HelpCircle, LogOut, ChevronRight, Settings } from 'lucide-react-native';
    ...
    <SafeAreaView className="flex-1 bg-white">
      <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
        ...
        <View className="px-6 pt-10 pb-12 items-center bg-gray-50 rounded-b-[50px] border-b border-gray-100">
          ...
          <Text className="text-3xl font-black text-black mt-6">{user?.name || 'Byke User'}</Text>
        ...
        <View className="px-6 py-10">
          <Text className="text-xs font-black text-gray-400 uppercase tracking-widest mb-6 ml-1">Account Overview</Text>
          ...
          <View className="space-y-4">
            ...
            >
              ...
              <Text className="flex-1 text-lg font-black text-red-500">Logout Session</Text>
        ...
        <View className="items-center pb-12">
          <Text className="text-[10px] font-black text-gray-300 uppercase tracking-[4px]">BYKE v1.0.1</Text>
        </View>
      </ScrollView>
    </SafeAreaView>
  );
